<?php 
	...
	$insert = $link->query("INSERT INTO  videos VALUES (0,'".$_POST["title"]."','".$_POST["source"]."')");
		...
		if(($insert)== TRUE){
			echo"<script>window.location.href = 'admin_videos.php';</script>";
		}
	}
?>
    ...
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-bg-2.jpg);">
        <div class="container-fluid page-header-inner py-5">
            <div class="container text-center">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Add YouTube Video</h1>
				...
				<div class="row">
					<div class="col-lg-12 form-group mt-3">
						<div style="background:#fff;border-radius:4px;background:#fff;border:1px solid #bbb;width:100%;box-shadow: rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px">
							...
							<div class='form-floating' style='margin:5px'>
								<textarea type='text' class='form-control' name='source' placeholder='Video Source (YouTube)' required ></textarea>
								<label for='source'>Video Source (YouTube)</label>
							</div>
						</div>
					</div>
