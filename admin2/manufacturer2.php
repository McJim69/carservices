...
<div class='row'>
	<div class='col-lg-12 grid-margin stretch-card'>
		<div class='card'>
			<div class='card-body'>
				<h4 class="card-title">Manufacturers &nbsp; 
					<a style="width:70px" onClick="jump('manufacturer.php')" class="btn btn-sm btn-outline-success">
						View All
					</a>
					<a style="width:70px" onClick="jump('manufacturer_add.php')" class="btn btn-sm btn-outline-success">
						+ ADD
					</a>
				</h4>
				<div class='row'  style='margin-bottom:-20px'>
					<?php
						$ex=$link->query("SELECT * FROM manufacturer ORDER BY rand() LIMIT 12") or die (mysqli_error($link));		
