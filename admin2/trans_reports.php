		...
		<?php	
				...
				<table class='table table-responsive text-light contab'>
					<thead style='text-transform:uppercase'>
						<tr>
							...
							<th scope='col'><small>Cient</small></th>
			...
			<div style='overflow-x:auto'>";
					...
					<div id='charts' class='text-center'>
						<div class='row lg-12 chartd bg-dark text-light'>
						<h4 class='text-light' style='margin-top:20px'>$post Total Sales &#8369;".number_format($sales,2)."</h4>
							<div class='col-lg-6'>&#8369;".number_format($sales,2)." 								
								<div id='chartContainer1' style='margin-bottom:12px;min-height: 300px; width: 100%'></div>													
							</div>
							<div class='col-lg-6'>&#8369;".number_format($stat,2)." $clid 
