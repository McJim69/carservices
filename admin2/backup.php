...
<?php
	...
	if((!isset($_POST["backup"])) && (!isset($_POST["upload"])) && (!isset($_POST["erase"]))){
	...
	if(isset($_POST["erase"])){
		...
		if($empty==TRUE){
			echo'
				...
				<div style="font-family: monospace;background:#000;color:#FFF;border-radius:5px;padding:20px;">
				<a href="backup.php"><input class="btn btn-outline-danger" type=button value=" Close Console " /></a><br><br>
				
				Database successfully erased.<br>
				...
				If this is a mistake, <a href="backup.php">RESTORE</a> your records from your latest downloaded database file.
	...
	if(isset($_POST["backup"])){
		...
		class Backup_Database {
			...
			protected function gzipBackupFile($level = 9) {
				...
				echo '<br><a href="'.$dest.'"><input class="btn btn-outline-success" type=button value="Download Backup" /></a><br>';
	...
	//RESTORE
		...
		//	fclose($fh); 
			...
			echo '
				...
				<div style="text-align:justify;font-family: monospace;background:#000;color:#FFF;border-radius:5px;padding:20px;">
				<a href="backup.php"><input class="btn btn-outline-danger" type=button value=" Close Console " /></a><br>
