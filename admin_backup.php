...
<div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-bg-2.jpg);">
	<div class="container-fluid page-header-inner py-5">
		<div class="container text-center">
			<h1 class="display-3 text-white mb-3 animated slideInDown">Backup & Restore</h1>
		...
		<div class="row justify-content-center">
			<div class="col-lg-6" style="margin-top:-60px">
				...
				<div class="col-lg-6" style="margin-top:10px">
					<input style='height:100px;width:300px;font-size:20px' class='btn btn-primary btn-sm' type='submit' name='backup' value="Backup DB" onclick="return confirm('Execute backup now?')" />
				</div>
				<div class="col-lg-6" style="margin-top:10px">
					<input style='height:100px;width:300px;font-size:20px' class='btn btn-success btn-sm' type='button' value="Restore DB" onclick="$('#file').click();" />
...
<div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
	<div class="container text-center" style="margin:-200px 5px 5px 5px">
		<div class="row justify-content-center">
			<div class="col-lg-10">
			<?php
